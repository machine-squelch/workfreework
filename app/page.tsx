    ...
    <>
      ...
      <Hero />
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-12">
                <div className="bg-gray-900 p-8 rounded-lg border-4 border-white shadow-2xl neon-border neon-backglow--white">
          ...
          <div className="p-8 rounded-2xl text-center border-4 border-white shadow-2xl neon-border neon-double-border--green">
                ...
                <div className="mt-8 p-6 rounded-xl border-4 border-sky-400 neon-border--blue neon-backglow--blue bg-sky-900/30">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* The Playbook */}
                <div className="bg-slate-800 p-8 rounded-lg border-2 border-slate-600 shadow-2xl  neon-border neon-backglow--white ">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Link href="/essays/ai-didnt-take-your-job" className="group">
                  <div className="bg-gray-800 p-6 rounded-lg border-2 border-gray-600 hover:shadow-2xl hover:border-gray-500 transition-all neon-border neon-backglow--white">
                ...
                <span className="neon-text-orange font-semibold">Read →</span>
              </div>
            </Link>
          ...
          <div className="space-y-8 mb-12">
                <div className=" p-8 rounded-2xl text-center border-4 border-white shadow-2xl card-glass-shimmer">
      ...
      <SocialProof />
          ...
          <section className="py-20 px-4 bg-gray-800 text-gray-200 border-t-4 border-gray-600 border-b-4 border-gray-600">
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="mb-8 flex justify-center">
                <div className="rounded-2xl p-4 border-4 border-white shadow-2xl neon-border card-glass-shimmer">
                  <Image
                    src="/may-z.png"
          ...
          <p className="text-xl text-gray-300 mb-4 max-w-3xl mx-auto font-semibold">
            Weekly sprints, revenue scorecards, and real operators shipping automation.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                <div className="bg-gray-900 p-6 rounded-lg border-4 border-white shadow-xl neon-border neon-backglow--white">
